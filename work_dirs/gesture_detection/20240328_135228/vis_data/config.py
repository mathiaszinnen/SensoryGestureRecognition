...
custom_imports = dict(
    ...
    imports=[
        'gesture_recognition.datasets.sniffyart_gesture_detection',
    ])
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home/woody/iwi5/iwi5093h/models/swin_base_patch4_window12_384_22kto1k-d59b0d1d.pth',
            prefix='backbone',
            type='Pretrained'),
        num_heads=[
            4,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        test_mode=True,
        type='SniffyArtGestureDetection'),
    drop_last=False,
    num_workers=2,
...
work_dir = './work_dirs/gesture_detection'
